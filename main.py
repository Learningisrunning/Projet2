...
class main: 
    ...
    def deroulement_du_programme(self):
        ...
        for tours_actuel in range(int(nombre_de_tours)):
            ...
            if tours_actuel == 1:
                ...
                #Classement des joueurs et ajout des infos à la liste des tours (rounds)
    ...
    def RecuperationDeData(self, liste_joueurs_du_tournois):
        ...
        #affichage des infos d'un tournoi sélectionné tournois (date, nom, list des joueurs, rounds)
